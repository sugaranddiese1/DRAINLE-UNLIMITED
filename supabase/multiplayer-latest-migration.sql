...
-- It includes the ten-guess limit and the censored live opponent progress RPC.
...
revoke execute on function public.get_blaidle_opponent_progress(text) from public,anon;
grant execute on function public.get_blaidle_opponent_progress(text) to authenticated;
